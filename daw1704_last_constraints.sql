...
--
-- Servidor: localhost
-- Tiempo de generación: 17-05-2017 a las 23:22:50
...
--
ALTER TABLE `answers`
  MODIFY `idanswer` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de la tabla `questions`
--
ALTER TABLE `questions`
  MODIFY `idquestion` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
...
--
ALTER TABLE `valorationa`
  MODIFY `idvalorationa` int(4) NOT NULL AUTO_INCREMENT;
--
